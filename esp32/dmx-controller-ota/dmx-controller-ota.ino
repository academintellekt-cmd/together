 ...
 * - Игрок 0: каналы 1-9 (PAN, PAN fine, TILT, TILT fine, Move speed, Shutter/Strobe/Dim, R, G, B)
 * - Игрок 1: каналы 10-18
 * - Игрок 2: каналы 19-27
 * - ... и так далее до игрока 13 (каналы 118-126)
 * 
 * ====================================================================
 * API ENDPOINTS
 * ====================================================================
...
void setup() {
  ...
  Serial.println("  - RGB каналы: 7, 8, 9 (в offset от startAddress каждого прожектора)");
