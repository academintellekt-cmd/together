 ...
 * - Встроенный LED (GPIO14) мигает при получении команд
...
// Пины ESP32
#define DMX_TX_PIN 12   // DI (Data In) - передача данных
#define DE_RE_PIN 14    // DE+RE - управление направлением (HIGH = передача)
#define LED_PIN 14      // Встроенный LED (тот же пин что и DE_RE_PIN)
...
void setupDMX() {
  ...
  // GPIO12 используется как TX2 на Serial2
